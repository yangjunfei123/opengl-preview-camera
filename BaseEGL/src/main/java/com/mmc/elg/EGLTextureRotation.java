...
/**
 * Created by yangjunfei on 11/10/18
 */
public class EGLTextureRotation {
    ...
    int mTexSampleHandle = 0;

    public EGLTextureRotation() {
    }
    ...
    public int rotate(int textureId, int rotation, boolean flipx, boolean flipY, ByteBuffer byteBuffer) {
        ...
        int useTexutreId = GLES20.GL_TEXTURE0;
